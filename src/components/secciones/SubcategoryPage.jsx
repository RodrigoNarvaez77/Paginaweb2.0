...
const SUBCATEGORY_DATA = {
  ...
  estructuras: {
    terciados: {
      title: "Terciados / Tableros de madera",
      products: [
        {
    ...
    fibrocemento: {
      ...
      products: [
        {
          id: "fibrocemento-6mm-120x240",
          name: "Fibrocemento Standard 120 x 240 x 6 mm (27.9 KG / 80 PL)",
          brand: "Standard",
          type: "Placa de fibrocemento",
          warranty: "N/A",
          color: "Gris claro",
          ...
          description:
            "Placa de fibrocemento Standard de 6 mm, ideal para revestimientos exteriores, tabiquería y zonas de humedad.",
          images: "/images/plancha_fibrocemento.webp",
          price: 14490,
        },
        {
          id: "fibrocemento-8mm-120x240",
          ...
          piecesPerPallet: "—",
          description:
            "Placa de fibrocemento Standard de 8 mm, ideal para aplicaciones estructurales y revestimientos exteriores.",
    ...
    volcanita: {
      title: "Volcanita / Yeso Cartón",
      products: [
        {
          id: "volcanita-std-10mm-1.2x2.4",
          ...
          piecesPerPallet: "—",
          description:
            "Placa de volcanita estándar Volcan de 10 mm, ideal para tabiques interiores, cielos y revestimientos en construcción.",
